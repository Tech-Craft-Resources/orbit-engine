...
\caption[Backend]{Backend}\tabularnewline
\toprule\noalign{}
...
\caption[Frontend]{Frontend}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Componente
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Infraestructura]{Infraestructura}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Componente
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}ll@{}}
\caption[Flujo de autenticación]{Flujo de autenticación}\tabularnewline
\toprule\noalign{}
Parámetro & Valor \\
\midrule\noalign{}
\endhead
...
\caption[Control de acceso basado en roles (RBAC)]{Control de acceso basado en roles (RBAC)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Tipo anotado
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Autenticación (/login)]{Autenticación (/login)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Usuarios (/users)]{Usuarios (/users)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Organizaciones (/organizations)]{Organizaciones (/organizations)}\tabularnewline
\toprule\noalign{}
...
\caption[Roles (/roles)]{Roles (/roles)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Categorías (/categories)]{Categorías (/categories)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Productos (/products)]{Productos (/products)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
...
\caption[Clientes (/customers)]{Clientes (/customers)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Ventas (/sales)]{Ventas (/sales)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Movimientos de inventario (/inventory-movements)]{Movimientos de inventario (/inventory-movements)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Dashboard (/dashboard)]{Dashboard (/dashboard)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Utilidades]{Utilidades}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Variables requeridas]{Variables requeridas}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Variable
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Variables opcionales con valores por defecto]{Variables opcionales con valores por defecto}\tabularnewline
\toprule\noalign{}
...
\caption[Propiedades calculadas (no en .env)]{Propiedades calculadas (no en .env)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Propiedad
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Backend (pytest)]{Backend (pytest)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Fixture
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
