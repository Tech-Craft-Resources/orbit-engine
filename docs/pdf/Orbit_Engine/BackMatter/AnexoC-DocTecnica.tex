\chapter{Documentación Técnica}\label{documentaciuxf3n-tuxe9cnica}
...
\multicolumn{5}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.9714} + 8\tabcolsep}@{}}{%
POST \textbar{} /organizations/signup \textbar{} No \textbar{} --- \textbar{} Registro de nueva organización + admin \textbar{}} \\
\end{longtable}
}
