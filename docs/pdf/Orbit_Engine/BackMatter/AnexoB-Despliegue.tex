...
\caption[Visión General]{Visión General}\tabularnewline
\toprule\noalign{}
...
\caption[Herramientas requeridas]{Herramientas requeridas}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Herramienta
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}lll@{}}
\caption[Puertos utilizados]{Puertos utilizados}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}ll@{}}
\caption[URLs del entorno local]{URLs del entorno local}\tabularnewline
\toprule\noalign{}
Servicio & URL \\
\midrule\noalign{}
\endhead
...
\caption[Migraciones del proyecto]{Migraciones del proyecto}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Archivo
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Solución de Problemas]{Solución de Problemas}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Problema
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
