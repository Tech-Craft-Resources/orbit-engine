\chapter{Capítulo 5. Resultados Técnicos}\label{capuxedtulo-5.-resultados-tuxe9cnicos}
...
\caption[Herramientas Empleadas]{Herramientas Empleadas}\tabularnewline
\toprule\noalign{}
...
\caption[Organizaciones del piloto técnico]{Organizaciones del piloto técnico}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
N°
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Composición del Piloto Técnico]{Composición del Piloto Técnico}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
...
\section{Pruebas de Carga (Backend / API) con Locust}\label{pruebas-de-carga-backend-api-con-locust}
...
\caption[Perfiles de Usuario Virtual]{Perfiles de Usuario Virtual}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Perfil
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0918}}@{}}
\caption[Escenarios Ejecutados]{Escenarios Ejecutados}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Escenario
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1500}}@{}}
\caption[Test 01]{Test 01. Carga Normal de Pyme}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Endpoint
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\textbf{Agregado} & N/A & 235 & 520 ms & 1 254 ms & 7 500 ms & 7 600 ms \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1324}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1324}}@{}}
\caption[Curva de Degradación]{Curva de Degradación}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Métrica
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1429}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1429}}@{}}
\caption[Comportamiento por Endpoint]{Comportamiento por Endpoint}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Escenario
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1481}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1296}}@{}}
\caption[Comportamiento por Endpoint (parte 2)]{Comportamiento por Endpoint (parte 2)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Escenario
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1455}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1273}}@{}}
\caption[Comportamiento por Endpoint (parte 3)]{Comportamiento por Endpoint (parte 3)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Escenario
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Comportamiento por Endpoint (parte 4)]{Comportamiento por Endpoint (parte 4)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Escenario
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1286}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1714}}@{}}
\caption[Comportamiento por Endpoint (parte 5)]{Comportamiento por Endpoint (parte 5)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Escenario
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1429}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1250}}@{}}
\caption[Comportamiento por Endpoint (parte 6)]{Comportamiento por Endpoint (parte 6)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Escenario
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0633}}@{}}
\caption[Puntajes y Web Vitals de Lighthouse por vista y organización]{Puntajes y Web Vitals de Lighthouse por vista y organización. La columna \emph{Tipo} indica si el \emph{tenant} corresponde a una empresa real del piloto o a un \emph{tenant} sintético de prueba}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Vista
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0549}}
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.1209}}@{}}
\caption[PageSpeed Insights: escritorio vs.~móvil]{PageSpeed Insights: escritorio vs.~móvil}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Vista
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Métricas clave reportadas por WebPageTest]{Métricas clave reportadas por WebPageTest}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Vista
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
Landing (\texttt{/}) & 46 ms & N/A & N/A & N/A & N/A & N/A & N/A & \textasciitilde752 ms & 3,9 MB \\
