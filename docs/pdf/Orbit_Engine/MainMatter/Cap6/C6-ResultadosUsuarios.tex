\chapter{Resultados de Usuarios}\label{resultados-de-usuarios}
...
\textbf{Tabla 6.3.2.} Tasa de error en inventario antes y después de la implementación --- Miss Peggy.
