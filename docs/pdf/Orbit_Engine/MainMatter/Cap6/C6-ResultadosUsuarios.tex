...
\caption[Instrumentos]{Instrumentos}\tabularnewline
\toprule\noalign{}
...
\caption[Caracterización de las empresas piloto del estudio de caso]{Caracterización de las empresas piloto del estudio de caso}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Atributo
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Comparación de tiempos medios por tarea administrativa (minutos)]{Comparación de tiempos medios por tarea administrativa (minutos)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Tarea
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Tasa de error en inventario antes y después de la implementación en Miss Peggy]{Tasa de error en inventario antes y después de la implementación en Miss Peggy}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Ítems auditados (pre)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0958}}@{}}
\caption[Resultados de las pruebas de tareas guiadas (agregado por tarea)]{Resultados de las pruebas de tareas guiadas (agregado por tarea)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
N°
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Scores SUS individuales por usuario]{Scores SUS individuales por usuario}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Empresa
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Score SUS agregado por empresa]{Score SUS agregado por empresa}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Empresa
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Score SUS global del piloto comparado con el benchmark de referencia]{Score SUS global del piloto comparado con el benchmark de referencia}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Métrica
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Media de respuesta por ítem SUS, valor ajustado (rango 0--4), todos los 7 usuarios]{Media de respuesta por ítem SUS, valor ajustado (rango 0--4), todos los 7 usuarios}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Ítem
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Resultados NPS por empresa y global]{Resultados NPS por empresa y global}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Empresa
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption[Scores CSAT medios por módulo y por empresa (escala 1--5)]{Scores CSAT medios por módulo y por empresa (escala 1--5)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Módulo
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}lll@{}}
\caption[Ranking de Módulos]{Ranking de Módulos}\tabularnewline
\toprule\noalign{}
...
\caption[Actividad registrada en producción durante la Fase 5 (por empresa)]{Actividad registrada en producción durante la Fase 5 (por empresa)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Métrica
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}ll@{}}
\caption[Temas Emergentes]{Temas Emergentes}\tabularnewline
\toprule\noalign{}
Empresa & Presente \\
\midrule\noalign{}
\endhead
...
\begin{longtable}[]{@{}ll@{}}
\caption[Temas Emergentes (parte 2)]{Temas Emergentes (parte 2)}\tabularnewline
\toprule\noalign{}
Empresa & Presente \\
\midrule\noalign{}
\endhead
...
\begin{longtable}[]{@{}ll@{}}
\caption[Temas Emergentes (parte 3)]{Temas Emergentes (parte 3)}\tabularnewline
\toprule\noalign{}
Empresa & Presente \\
\midrule\noalign{}
\endhead
...
\caption[Temas Emergentes (parte 4)]{Temas Emergentes (parte 4)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Empresa
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}ll@{}}
\caption[Temas Emergentes (parte 5)]{Temas Emergentes (parte 5)}\tabularnewline
\toprule\noalign{}
...
\caption[Tabla Resumen de Validación de Hipótesis]{Tabla Resumen de Validación de Hipótesis}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Hipótesis
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
