\chapter{Capítulo 2. Marco de Referencia}\label{capuxedtulo-2.-marco-de-referencia}
...
\begin{longtable}[]{@{}lll@{}}
\caption[Pequeña y Mediana Empresa (Pyme)]{Pequeña y Mediana Empresa (Pyme)}\tabularnewline
\toprule\noalign{}
...
\caption[Arquitectura Multi-Tenant]{Arquitectura Multi-Tenant}\tabularnewline
\toprule\noalign{}
...
\caption[Análisis Comparativo]{Análisis Comparativo}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Criterio
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
